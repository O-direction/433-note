...
public class MainActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        String bgText = "您已经写了<font color='#000'>"+wholeCount+"</font>个便签<br>" +
                "完成了<font color='#000'>"+complishCount+"</font>个<br>" +
                "未完成<font color='#000'>"+continueCount+"</font>个<br><br>" +
                "Developed By <font color='#999999'>BUCT-433</font><br>" +
                "本项目由<font color='#999999'>BUCT-433</font>开发";
    ...
    private void addGuide(){
        ...
        doInsert("教程一","点击右下角加号可以编写新便签，长按可以删除便签",thisDate,0);
        doInsert("教程二","首页列表根据最近一次更新的时间进行排序",thisDate,-1);
        doInsert("教程三","可以插入图片",thisDate,-2);
        doInsert("教程四","首页下拉可以看到你所有便签的状态哦",thisDate,-3);
        doInsert("教程五","想了解更多信息，点击\"关于\"试试看吧",thisDate,-4);
        doInsert("教程六","开始创建一个新的便签试试吧",thisDate,-5);
    }
